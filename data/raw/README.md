...
| partner_pricing.csv | Partner-level pricing assignment and negotiated pricing values |
| pricing_plans.csv | Pricing plan reference table |
| pricing_exceptions.csv | Pricing exception requests and approval status |
| monthly_partner_metrics.csv | Monthly transaction, payment volume, growth, approval, chargeback, revenue, and margin metrics |
